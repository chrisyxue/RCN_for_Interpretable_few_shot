...
data_dir = '/opt/data/private/X-AI/datas/CUB_200_2011'              # the path of the download dataset
save_dir = '/opt/data/private/X-AI/datas/CUB_200_2011/For_Few_Shot'  # the saving path of the divided dataset
